...
@Table(name = "marketingPic")
public class MarketingPic extends BaseModel {
	private static final long serialVersionUID = 1L;
	/*图片地址**/
	@io.swagger.annotations.ApiModelProperty(value="图片地址",name="picUrl")
	private String picUrl;
	/*链接**/
	@io.swagger.annotations.ApiModelProperty(value="链接",name="link")
	private String link;
	/*[GTE][LTE]**/
	...
	public static enum Field
	{
		Id_ASC("`id` ASC"),Id_DESC("`id` DESC")
			...
			,Link_ASC("`link` ASC"),Link_DESC("`link` DESC")
	...
	public void setSortColumns(MarketingPic.Field... fields)
	{
