...
public class Suggestion extends BaseModel {
	...
	/*星级**/
	@io.swagger.annotations.ApiModelProperty(value="星级",name="startLevel")
	...
	public void setStartLevel(Integer _startLevel) {
	...
	public static enum Field
	{
		Id_ASC("`id` ASC"),Id_DESC("`id` DESC")
			...
			,StartLevel_ASC("`startLevel` ASC"),StartLevel_DESC("`startLevel` DESC")
	...
	public void setSortColumns(Suggestion.Field... fields)
	{
