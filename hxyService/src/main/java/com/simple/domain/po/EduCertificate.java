...
public class EduCertificate extends BaseModel {
	...
	/***/
	@io.swagger.annotations.ApiModelProperty(value="",name="link")
	private String link;
	/*[GTE][LTE]**/
	...
	public void setSortColumns(EduCertificate.Field... fields)
	{
