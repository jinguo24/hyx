...
public class Question extends BaseModel {
	...
	/*查看次数**/
	@io.swagger.annotations.ApiModelProperty(value="查看次数",name="queryCount")
	...
	public static enum Field
	{
		Id_ASC("`id` ASC"),Id_DESC("`id` DESC")
			,Question_ASC("`question` ASC"),Question_DESC("`question` DESC")
	...
	public void setSortColumns(Question.Field... fields)
	{
